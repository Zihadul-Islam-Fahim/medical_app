          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                Row(
                  children: [
                    Text("Your information",style: TextStyle(fontFamily: 'mn',fontWeight: FontWeight.bold),),
                  ],
                ),
                const SizedBox(
                  height: 10,
                ...
                Row(
                  children: [
                    Text("Shipping information",style: TextStyle(fontFamily: 'mn',fontWeight: FontWeight.bold),),
                  ],
                ),
                const SizedBox(
                  height: 10,
